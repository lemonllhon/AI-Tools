...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::proxy_pool::proxy_runtime_open_resource_dir,
            ...
            commands::proxy_pool::proxy_pool_check_import_preview,
            commands::proxy_pool::proxy_pool_apply_import,
            commands::proxy_pool::proxy_pool_preview_subscription,
            commands::proxy_pool::proxy_pool_check_subscription_preview,
            ...
            commands::codex::update_all_codex_account_app_speeds,
